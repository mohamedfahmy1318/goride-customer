...
class IntercityCompleteOrderScreen extends StatelessWidget {
  const IntercityCompleteOrderScreen({super.key});
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              Constant.amountShow(
                                                                  amount: Constant()
                                                                      .calculateTax(
                                                                          amount: (double.parse(controller.orderModel.value.finalRate.toString()) - double.parse(controller.couponAmount.value.toString()))
                                                                              .toString(),
                                                                          taxModel:
                                                                              taxModel)
                                                                      .toString()),
